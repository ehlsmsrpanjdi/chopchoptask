...
public class SkillDataManager
{
    ...
    void Init()
    {
        ...
        data.Add(3, new SkillData(3, 2f, 10, 1, 4, 15, skillEnum.Passive));  // 130% 효과, 10초 동작, 횟수 1회, 4번 이펙트 사용, 15초 쿨타임, 페시브 타입
        ...
        data.Add(8, new SkillData(8, 2f, 3, 1, 3, 5, skillEnum.Passive));  // 
        data.Add(9, new SkillData(9, 2f, 3, 1, 5, 5, skillEnum.Passive));  // 
    }
